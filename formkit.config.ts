...
const config = {
  config: {
    classes: generateClasses({
      ...
      submit: {
        input: '$reset bg-blue-500 hover:bg-blue-600 transition-colors p-3 text-white font-bold rounded w-full mt-10 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-blue-600',
      }
    })
  }
}
